...
public void readSettings()
{
  ...
  if(PApplet.parseBoolean(midiConfig.getString("active")))
  {
  ...
  if(PApplet.parseBoolean(oscConfig.getString("active")))
  {
  ...
  if(PApplet.parseBoolean(dmxConfig.getString("active")))
  {
